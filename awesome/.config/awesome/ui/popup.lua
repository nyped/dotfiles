...
awesome.connect_signal("theme_change", function(state)
    popup:on_theme_change(state)
end)

awesome.connect_signal("screen_backlight_change", function(percentage)
    popup:on_screen_update(percentage)
end)

awesome.connect_signal("screen_bluelight_change", function(percentage)
    popup:on_bluelight_update(percentage)
end)

awesome.connect_signal("keyboard_backlight_change", function(percentage)
