#!/bin/bash
# creds: https://raw.githubusercontent.com/tiny-pilot/tinypilot/refs/heads/master/debian-pkg/opt/tinypilot-privileged/init-usb-gadget
...
if [[ -d /sys/kernel/config/usb_gadget/g1/functions ]]; then
  echo Skipping gadget init
  exit 0
fi
