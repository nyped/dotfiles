...
let s:N2 = [ '#e4e4e4' , '#ff9933' , 254 , 31  ] " Info
let s:N3 = [ '#263238' , '#ffa64d' , 255 , 24  ] " StatusLine
...
let g:airline#themes#papercolormod#palette.normal_modified = {
      \ 'airline_c': [ '#263238' , '#ffa64d' , 255 , 24 , '' ] ,
      \ }


" Insert Mode:
let s:I1 = [ '#263238' , '#e4e4e4' , 240 , 254 ] " Mode
let s:I2 = [ '#e4e4e4' , '#ff9933' , 254 , 31  ] " Info
let s:I3 = [ '#263238' , '#ffa64d' , 255 , 24  ] " StatusLine
...
" Visual Mode:
let s:V1 = [ '#ffa64d', '#e4e4e4', 24,  254 ]
let s:V2 = [ '',        '#ff9933', '',  31  ]
let s:V3 = [ '#263238', '#ffa64d', 254, 24  ]
...
let g:airline#themes#papercolormod#palette.visual_modified = {
      \ 'airline_c': [ '#e4e4e4', '#ffa64d', 254, 24  ] ,
      \ }
...
let g:airline#themes#papercolormod#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
      \ [ '#e4e4e4' , '#ffa64d' , 254 , 24  , ''     ] ,
      \ [ '#e4e4e4' , '#ff9933' , 254 , 31  , ''     ] ,
